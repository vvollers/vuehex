...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>—</td>
      <td>Color theme: <code>'dark'</code>, <code>'light'</code>, <code>'terminal'</code>, <code>'sunset'</code>, or <code>'auto'</code>.</td>
    </tr>
    <tr>
...
VueHex supports three v-model bindings:
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>The currently visible data buffer.</td>
    </tr>
    <tr>
      <td><code>v-model:window-offset</code></td>
      <td><code>number</code></td>
      <td>Absolute byte offset of the current window (two-way binding).</td>
    </tr>
    <tr>
      <td><code>v-model:cursorLocation</code></td>
      <td><code>number | null</code></td>
      <td>Current cursor position for keyboard navigation.</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>cursor-change</code></td>
      <td><code>&#123; index: number | null &#125;</code></td>
      <td>Emitted when cursor position changes.</td>
    </tr>
    <tr>
